...
| [SimpleMDM-MCP](https://github.com/hov172/SimpleMDM-MCP) | MCP (Model Context Protocol) server for SimpleMDM. Query and manage your fleet using natural language through Claude Desktop, Claude Code, or any MCP-compatible client. Supports ~115 tools covering the full SimpleMDM API surface with read-only safety defaults and optional write actions. | TypeScript / Node.js | July 29th 2026 |
| [SimpleMDM-MunkiReport](https://github.com/hov172/SimpleMDM-MunkiReport) | MunkiReport module that syncs SimpleMDM device inventory and API resources server-side. Provides fleet dashboards, compliance widgets, per-device connected resource views, webhook ingestion, delta sync, and client-reporter ingestion. *(Beta)* | PHP / Python | July 11th 2026 |
