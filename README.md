...
| [SimpleMDM-MunkiReport](https://github.com/hov172/SimpleMDM-MunkiReport) | MunkiReport module that syncs SimpleMDM device inventory and API resources server-side. Provides fleet dashboards, compliance widgets, per-device connected resource views, webhook ingestion, delta sync, and client-reporter ingestion. *(Beta)* | PHP / Python | 2026 |
...
| [Signaro](https://github.com/hov172/Signaro) | macOS app for signing, notarizing, and analyzing .pkg/.app/.mobileconfig files. | macOS | Dec 17, 2025 |
